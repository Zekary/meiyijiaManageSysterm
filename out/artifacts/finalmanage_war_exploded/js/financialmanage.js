...
sure.onclick = function () {
    var form = document.getElementById("financialform");
    form.action = "FinancialServlet?action=add";
    form.method = "post";
    form.submit();
...
Select.onclick = function () {
    ...
    if (confirm("是否删除这些信息")) {
        ...
        window.location.href = "FinancialServlet?action=delS&comp="+compatibility;
    }
    // console.log(k);
}

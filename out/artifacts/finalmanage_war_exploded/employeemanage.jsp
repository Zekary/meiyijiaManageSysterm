    ...
    <table class="table table-hover table-bordered" style="width: 95%;">
        ...
        <c:forEach items="${requestScope.employeelist}" var="emp">
            <tr>
                ...
                <td>${emp.getEdate()}</td>
                <td>
                    <button type="button" class="btn btn-danger" onclick="Del(this)"><a href="EmployeeServlet?action=delete&empid=${emp.empid}">删除</a></button>
                    <button type="button" class="btn btn-info" onclick="Edit(this)"><a href="EmployeeServlet?action=gete&empid=${emp.getEmpid()}">修改</a></button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<div class="create" id="create">
    <div class="create_center">
        ...
        <form id="empform">
            ...
            <label>年&nbsp;&nbsp;&nbsp;&nbsp;龄：</label> <input type="text" id="empage" value="" name="age"><br>
            <label>性&nbsp;&nbsp;&nbsp;&nbsp;别：</label> <input type="text" id="sex" value="" name="sex">
            <label>工&nbsp;&nbsp;&nbsp;&nbsp;资：</label> <input type="text" id="sal" value="" name="salary"><br>
            <label>生&nbsp;&nbsp;&nbsp;&nbsp;日：</label> <input type="text" id="birth" value="" name="birthday"><br>
            <label>入职日期：</label> <input type="text" id="edate" value="" name="edate"><br>

...
<div style="margin-top: 10%; margin-left: 10%">
    <form name="eupdateform" action="EmployeeServlet?action=update&empid=${requestScope.employee.empid}" method="post">
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="empage" name="empage" value="${requestScope.employee.age}">
            </div>
        </div>
        ...
        <div class="form-row" >
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="sex" name="sex" value="${requestScope.employee.sex}">
            </div>

            <div class="form-group col-md-4">
                <label for="sal">工资</label>
                <input type="text" class="form-control" id="sal" name="sal" value="${requestScope.employee.salary}">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="birth" name="birth" value="${requestScope.employee.birthday}">
            </div>

            <div class="form-group col-md-4">
                <label for="edate">入职日期</label>
                <input type="text" class="form-control" id="edate" name="edate" value="${requestScope.employee.edate}">
            </div>
            <div class="form-group col-md-4" style="margin-top: 31px; margin-left: 2%;">
                ...
                <button type="button" class="btn btn-outline-primary" id="btn-reset" onclick="location.href=('EmployeeServlet?action=list')">取消</button>
            </div>
        </div>
    </form>
</div>

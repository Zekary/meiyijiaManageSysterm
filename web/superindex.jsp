...
<div class="page" id="app">
                ...
                <ul>
                    <li class="nav-tab waves-effect">
                        <a href="javascript:void[0]" class="li-a active">
                            <a href="UserServlet?action=list" class="li-a" target="iframe">
                                <i class='bx bx-layer'></i> 店长管理
                            </a>
                        </a>
                    </li>
                    ...
                    <li class="nav-tab waves-effect">
                        <a href="javascript:void[0]" class="li-a active">
                            <a href="EmployeeServlet?action=list" class="li-a" target="iframe">
                                <i class='bx bx-layer'></i> 员工管理 <span class="badge badge-pill badge-primary float-right">2</span>
                            </a>
                        </a>
                        <div class="nav-box">
                    ...
                    <li class="nav-tab nav-ul">
                        <a href="javascript:void[0]" class="li-a">
                            <a href="GoodsServlet?action=list" target="iframe" class="li-a">
                                <i class='bx bx-cog'></i> 商品信息管理<i class='bx bx-chevron-right' style="float: right;"></i>
                    ...
                    <li class="nav-tab nav-ul">
                        <a href="javascript:void[0]" class="li-a">
                            <a href="FinancialServlet?action=list" target="iframe" class="li-a">
                                <i class='bx bx-cog'></i> 财务信息管理<i class='bx bx-chevron-right' style="float: right;"></i>
                                <span class="badge badge-pill badge-primary float-right">3</span>
                            </a>
                        </a>
                    </li>
    ...
    <div class="nav-right bg-dark">
        <div class="nav-top bg-light row justify-content-between bg-dark">
            ...
            <%
                out.println("用户名：" + username + "       " + store);
            %>
          </span></h2>
            <button type="button" class="btn btn-outline-info col-md-auto" onclick="window.location.href = 'LogoutServlet'">注销</button>
        </div>
        <div class="content-page ">
            <iframe name="iframe" width="100%" height="100%" frameborder="0" src="UserServlet?action=list" style="width: 102%"></iframe>
        </div>
    </div>
</div>
